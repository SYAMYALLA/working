...
public class EmployeeDaoImplJDBC implements IemployeeDao {
	...
	String url = "jdbc:mysql://localhost:3306/test"+","+"root"+","+"password";
	//private String s;
	...
	public void addEmployee(Employee e)
		...
		dbConnection = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","password");
